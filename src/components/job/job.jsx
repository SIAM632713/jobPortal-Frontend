                        ...
                        {currentItems.map((item, index) => (
                            ...
                            >
                                <div className="flex justify-between items-start">
                                    <p className="text-sm text-gray-500">{daysAgoFunction(item?.createdAt) === 0 ? "Today" : `${daysAgoFunction(item?.createdAt)} day ago`}</p>
                                    <button>
                                        <svg
                                ...
                                <div className="flex gap-2 mt-4">
                                    <Link to={`/jobDescription/${item?._id}`}
                                          className="px-4 py-1 border rounded hover:bg-gray-100 text-sm">Details</Link>
                                    <button
