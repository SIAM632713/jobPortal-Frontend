        ...
        <div className="max-w-[1400px] mx-auto">
            <div className="flex justify-center items-center mt-15">
                <Carousel className="w-full max-w-6xl relative">
                        ...
                        {roles.map((role, index) => (
                            <CarouselItem key={index} className="basis-1/3 flex justify-center">
                                <button
                                    ...
                                    className={`px-6 py-2 border rounded-full shadow-sm transition font-medium ${
                                        title === role
                    ...
                    <CarouselPrevious
                        className="absolute left-0 -translate-y-1/2 top-1/2 bg-white border border-gray-300 shadow-sm p-2 rounded-full hover:shadow-md z-10">
                        <ArrowLeft className="w-4 h-4"/>
                    </CarouselPrevious>

                    <CarouselNext
                        className="absolute right-0 -translate-y-1/2 top-1/2 bg-white border border-gray-300 shadow-sm p-2 rounded-full hover:shadow-md z-10">
